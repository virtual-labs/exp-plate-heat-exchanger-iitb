...
function activity7() {
    ...
    let hide_btn: HTMLButtonElement = <HTMLButtonElement> document.getElementsByClassName('offcanvasbtn')[1];
...
function verify1() {
    ...
    let val1: HTMLInputElement = <HTMLInputElement>document.getElementById("v-inp");
    let val2: HTMLInputElement = <HTMLInputElement>document.getElementById("m-inp");
    let val3: HTMLInputElement = <HTMLInputElement>document.getElementById("u-inp");
    let val4: HTMLInputElement = <HTMLInputElement>document.getElementById("lmtd-inp");
    let val5: HTMLInputElement = <HTMLInputElement>document.getElementById("q-inp");
    let val6: HTMLInputElement = <HTMLInputElement>document.getElementById("ui-inp");
    let val7: HTMLInputElement = <HTMLInputElement>document.getElementById("lnui-inp");
    let val8: HTMLInputElement = <HTMLInputElement>document.getElementById("lnm-inp");
    ...
    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('verify-1-btn');
...
function verify2() {
    ...
    let val1: HTMLInputElement = <HTMLInputElement>document.getElementById("m256-inp");
    let val2: HTMLInputElement = <HTMLInputElement>document.getElementById("m-256-inp");
    let val3: HTMLInputElement = <HTMLInputElement>document.getElementById("re-inp");
    let val4: HTMLInputElement = <HTMLInputElement>document.getElementById("pr-inp");
    let val5: HTMLInputElement = <HTMLInputElement>document.getElementById("ui-1-inp");
    let val6: HTMLInputElement = <HTMLInputElement>document.getElementById("ho-1-inp");
    let val7: HTMLInputElement = <HTMLInputElement>document.getElementById("hi-1-inp");
    let val8: HTMLInputElement = <HTMLInputElement>document.getElementById("hi_exp-inp");
    let val9: HTMLInputElement = <HTMLInputElement>document.getElementById("hi_theo-inp");
    ...
    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('verify-2-btn');
